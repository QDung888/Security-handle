...
/* Private defines -----------------------------------------------------------*/
#define TX_Reader_Pin GPIO_PIN_2
#define TX_Reader_GPIO_Port GPIOA
#define RX_Reader_Pin GPIO_PIN_3
#define RX_Reader_GPIO_Port GPIOA
#define LED_Pin GPIO_PIN_4
#define LED_GPIO_Port GPIOA
#define LED_onBoard_Pin GPIO_PIN_2
